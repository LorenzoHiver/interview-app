...
export const postBeerRating = (uuid, score) => ({
  type: BeerActionTypes.BEERS_SET_RATING,
  uuid, score,
});

export const setBeerRatingSuccess = (updatedItem) => ({
  type: BeerActionTypes.BEERS_SET_RATING_SUCCESS,
  updatedItem
});